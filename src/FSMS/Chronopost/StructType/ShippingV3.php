...
class ShippingV3 extends AbstractStructBase
{
     ...
     * Set esdValue value
     * @param \FSMS\Chronopost\StructType\EsdValue $esdValue
     * @return \FSMS\Chronopost\StructType\ShippingV3
     */
