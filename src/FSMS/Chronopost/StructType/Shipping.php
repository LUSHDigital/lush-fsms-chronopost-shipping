...
class Shipping extends AbstractStructBase
{
     ...
     * Set esdValue value
     * @param \FSMS\Chronopost\StructType\EsdValue $esdValue
     * @return \FSMS\Chronopost\StructType\Shipping
     */
