...
class ResultEnlevementNational extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \FSMS\Chronopost\StructType\InfoEnlevement|null
     */
    protected ?\FSMS\Chronopost\StructType\InfoEnlevement $infoEnlevement = null;
    /**
     * The libelleErreur
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \FSMS\Chronopost\StructType\InfoEnlevement $infoEnlevement
     * @param string $libelleErreur
     */
    public function __construct(?int $codeErreur = null, ?\FSMS\Chronopost\StructType\InfoEnlevement $infoEnlevement = null, ?string $libelleErreur = null)
    {
        $this
     ...
     * @param int $codeErreur
     * @return \FSMS\Chronopost\StructType\ResultEnlevementNational
     */
     ...
     * @return \FSMS\Chronopost\StructType\InfoEnlevement|null
     */
    public function getInfoEnlevement(): ?\FSMS\Chronopost\StructType\InfoEnlevement
    {
     ...
     * @return \FSMS\Chronopost\StructType\ResultEnlevementNational
     */
    public function setInfoEnlevement(?\FSMS\Chronopost\StructType\InfoEnlevement $infoEnlevement = null): self
    {
