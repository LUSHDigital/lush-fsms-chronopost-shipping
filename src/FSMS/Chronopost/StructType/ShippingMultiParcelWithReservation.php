...
class ShippingMultiParcelWithReservation extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \FSMS\Chronopost\StructType\SkybillWithDimensionsValue[]
     */
     ...
     * @param \FSMS\Chronopost\StructType\SkybillWithDimensionsValue[] $skybillValue
     ...
     * Set esdValue value
     * @param \FSMS\Chronopost\StructType\EsdWithRefClientValue $esdValue
     * @return \FSMS\Chronopost\StructType\ShippingMultiParcelWithReservation
     */
    ...
    public static function validateRecipientValueForArrayConstraintFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelWithReservationRecipientValueItem) {
            ...
            if (!$shippingMultiParcelWithReservationRecipientValueItem instanceof \FSMS\Chronopost\StructType\RecipientValue) {
    ...
    public static function validateRefValueForArrayConstraintFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelWithReservationRefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelWithReservationRefValueItem instanceof \FSMS\Chronopost\StructType\RefValue) {
     ...
     * @return \FSMS\Chronopost\StructType\SkybillWithDimensionsValue[]
     */
    ...
    public static function validateSkybillValueForArrayConstraintFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelWithReservationSkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelWithReservationSkybillValueItem instanceof \FSMS\Chronopost\StructType\SkybillWithDimensionsValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The skybillValue property can only contain items of type \FSMS\Chronopost\StructType\SkybillWithDimensionsValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \FSMS\Chronopost\StructType\SkybillWithDimensionsValue $item
     * @return \FSMS\Chronopost\StructType\ShippingMultiParcelWithReservation
     */
    public function addToSkybillValue(\FSMS\Chronopost\StructType\SkybillWithDimensionsValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \FSMS\Chronopost\StructType\SkybillWithDimensionsValue) {
            throw new InvalidArgumentException(sprintf('The skybillValue property can only contain items of type \FSMS\Chronopost\StructType\SkybillWithDimensionsValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
